    ...
    <div class="left_form container" style="height:auto;">
        <div class="mf_inside col-sm-12 col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2">
            <div class="lf_form form-horizontal">
                <div class="lff_part">
                    <h3>U.S.transportation</h3>
                    <hr>
                    <div class="form-group">
                        <label>Аукцион</label>
                        <select class="custom-select auction form-control" id="calc_data1_select" name="calc_data1_select" onchange="select_auction(this);get_calc();">
                    ...
                    <div class="form-group">
                        <label>Локация</label>
                        <select class="custom-select subauction form-control" style="width: 100%" id="calc_data2_select" name="calc_data2_select" onchange="select_location(this);get_calc(this);">
                            <option value="">Выберите локацию</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Порт</label>
                        <select class="custom-select exit_port form-control" style="width: 100%" id="calc_data2_select" name="calc_data2_select" onchange="get_calc(this);">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control price_selects" onchange="get_calc(this);">
                        <option value="price_3cars">4 CONT (SUV)</option>
                        <option value="price_2cars">3 CONT (Седан)</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="custom-select subcountry form-control" style="width: 100%" id="calc_data2_select" name="calc_data2_select" onchange="get_calc(this);">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        Аукцион
                        <span class="badge badge-primary badge-pill" id="type-auction"></span>
                    </li>
                </ul>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <ul class="list-group">
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        Выгрузка в порту и таможенные услуги
            ...
            <div class="col-md-6">
                <ul class="list-group">
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        Страна
                        <span class="badge badge-primary badge-pill">Ukraine</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        Портовый город
                        <span class="badge badge-primary badge-pill" id="js-subcountry"></span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        Тип двигателя
                        <span class="badge badge-primary badge-pill" id="type-motor"></span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        Топливо
                        <span class="badge badge-primary badge-pill" id="type-fuel"></span>
                    </li>
                </ul>
            </div>
            <div class="col-md-6">
                <ul class="list-group">
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        Локация
                        <span class="badge badge-primary badge-pill" id="js-location"></span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        Порт
                        <span class="badge badge-primary badge-pill" id="port"></span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        Тип автомобиля
                        <span class="badge badge-primary badge-pill" id="type-auto"></span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        Возраст авто
                        <span class="badge badge-primary badge-pill" id="type-age"></span>
                    </li>
                </ul>
            </div>
        </div>
